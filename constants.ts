...
export const MENU_ITEMS: MenuItem[] = [
  { id: 'db-bibit-ai', title: 'Dashboard Bibit AI', icon: 'fa-robot', href: 'https://ebastari.github.io/dasboard-AI/testdas45.html', badge: 'AI' },
  ...
  { id: 'developer-info', title: 'Informasi Developer', icon: 'fa-code', href: '#' },
  { id: 'bibit-notification', title: 'Notifikasi Bibit', icon: 'fa-bell', href: '#' },
];